    ...
    async with async_playwright() as p:
        browser = await p.chromium.launch(
            ...
            args=[
                ...
                "--disable-features=TranslateUI,Prefetch,MediaRouter,OptimizationHints,InterestFeedContent,AudioServiceOutOfProcess,IsolateOrigins,site-per-process,TranslateUI",
                "--blink-settings=imagesEnabled=false,cssEnabled=false,fontRendering=false",
                "--mute-audio",
                "--hide-scrollbars",
                "--disable-sync",
                "--disable-logging",
        ...
        while True:
            ...
            if time.time() - last_refresh_time_ref[0] >= 75 and pending_page_ref[0] is None and (not refresh_task or refresh_task.done()):
